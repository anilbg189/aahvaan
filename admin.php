          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-center" id="exampleModalLabel">Add Event &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<a href="logout.php">Logout</a></h5>
                ...
                <div class="modal-body">
                  <form name="myform"action="adminsum.php" method="post"enctype="multipart/form-data">
                   ...
                   <div class="text-center">
                      <<button class="btn btn-unique">ADD <i class="fa fa-paper-plane-o ml-1"></i></button>
