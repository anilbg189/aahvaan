                ...
                <div class="modal-body">
                  <form name="myform"action="sum.php" method="post">
                    ...
                    <div class="md-form">
                        ...
                        <input type="email" id="form2" onBlur="checkAvailability()" placeholder="Your email"required name="email" class="form-control">
                    ...
                    <div class="md-form">
                        ...
                        <input type="text" id="form32"placeholder="Your USN" maxlength="10" required name="usn" class="form-control">

                    </div>

                    <div class="md-form">
                        <i class="fa fa-phone prefix grey-text"></i>
                        <input type="text" id="form8"placeholder="Your Phone"required length="10" name="phone" class="form-control" >
